...
from api.internal.admin.products import ProductHelper
...
class Test(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.products[0].barcode = '12345'
        self.products[0].creator = self.users[0].key
        self.products[0].put()

        self.prod_ings = []
        self.prod_ings.append(ProductIngredient())
        self.prod_ings[0].ingredient = self.ingredients[0].key
        self.prod_ings[0].product = self.products[0].key
        self.prod_ings[0].put()
